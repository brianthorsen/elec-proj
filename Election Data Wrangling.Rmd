...
elecData1 <- merge(elecData, Election08, by.x = c("state.x", "county.x"), by.y = c("stateName", "County"), all.x = TRUE, all.y = TRUE)
...
To simplify operations in the second half of this project, it will be useful to tidy up our primary data frame. This will be accomplished by (a) dropping redundant variables, and (b) renaming the columns of our data frame as needed.
